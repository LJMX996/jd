...
[task_local]
#汪汪乐园每日任务
0 0,7,9,17,20 * * * jd_joy_park.js, tag=汪汪乐园每日任务, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_joypark_task.png, enabled=true
================Loon==============
[Script]
cron "0 0,7,9,17,20 * * *" script-path=jd_joy_park.js,tag=汪汪乐园每日任务
===============Surge=================
