ql repo https://github.com/LJMX996/jd.git "jd_|jx_|pull|gua_|code_|zy_" "tmp" "JDJRValidator_Pure.js|sign_graphics_validate.js|MovementFaker.js|ZooFaker_Necklace.js" "aaron" 
