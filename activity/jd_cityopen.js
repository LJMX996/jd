          ...
          if (safeGet(data)) {
            ...
            if (data.code === 0) {
              if (data.data && data['data']['bizCode'] === 0) {
                if (flag) console.log(` ${data.data && data.data.result.userActBaseInfo.inviteId}\n`);
